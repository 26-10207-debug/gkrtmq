...
원본은 파일당 8MB, 최대 5개, 합계 32MB까지 보관합니다. 모든 형식을 동일하게 실행하는 것은 아닙니다. HTML·CSS·JavaScript·WebAssembly로 만든 브라우저용 자료를 웹 실행기로 엽니다. EXE·APK와 서버용 코드는 원본 보관·다운로드가 가능합니다.
